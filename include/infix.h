#ifndef LONGCALC_H_INFIX
#define LONGCALC_H_INFIX

/* В заголовочном файле infix.h описаны функции, выполняющие преобразование выражения,
   записанного в инфиксной форме записи, с числами в прямом коде в выражение, записан-
   ное в постфиксной форме записи, с числами в дополнительном коде. */
...
Set s_binop = {"+-*", 3}; // множество ОПЕРАТОР
Set s_term = {"\0", 1}; // множество ТЕРМИНАТОР
Set s_spc = {"\x20\x00", 1}; // множество ПРОБЕЛ

/* функции, отвечающие за необходимость извлечения оператора из стека */
